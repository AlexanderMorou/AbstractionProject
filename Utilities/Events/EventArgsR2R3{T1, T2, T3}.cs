...
namespace AllenCopeland.Abstraction.Utilities.Events
{
    ...
    /// </summary>
    /// <typeparam name="TArg1">The type for the first argument.</typeparam>
    ...
    #endif
    public class EventArgsR2R3<TArg1, TArg2, TArg3> :
        EventArgsR2<TArg1, TArg2>
    {
        /// <summary>
        /// Creates a new <see cref="EventArgsR1R2R3{TArg1, TArg2, TArg3}"/> with the
        /// <paramref name="arg1"/>, the required <paramref name="arg2"/>, 
        /// and the required <paramref name="arg3"/>.
        /// </summary>
        ...
        /// argument that is immutable after instantiation.</param>
        public EventArgsR2R3(TArg1 arg1, TArg2 arg2, TArg3 arg3)
            : base(arg1, arg2)
        {
            this.Arg3 = arg3;
        }
        ...
        /// <param name="arg3">The required <typeparamref name="TArg3"/>
        /// argument that is immutable after instantiation.</param>
        public EventArgsR2R3(TArg2 arg2, TArg3 arg3)
            : base(arg2)
        {
            this.Arg3 = arg3;
        }
