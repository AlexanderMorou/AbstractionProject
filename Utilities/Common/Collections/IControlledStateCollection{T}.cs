...
namespace AllenCopeland.Abstraction.Utilities.Collections
{
        ...
        ICountableEnumerable<T>
    {
        ...
        /// <summary>
        /// Determines whether the <see cref="IControlledCollection{T}"/> contains a specific 
        /// value.</summary>
        /// <param name="item">
        /// The object to locate in the <see cref="IControlledCollection{T}"/>.</param>
        /// <returns>
        /// true if <paramref name="item"/> is found in the <see cref="IControlledCollection{T}"/>;
        /// otherwise, false.
        /// </returns>
        bool Contains(T item);

        /// <summary>
        /// Copies the elements of the <see cref="IControlledCollection{T}"/> to an
        ...
        /// elements copied from <see cref="IControlledCollection{T}"/>. The 
        ...
        /// number of elements in the source <see cref="IControlledCollection{T}"/> is greater 
        ...
        /// <see cref="IControlledCollection{T}"/>.
        /// </exception>
        T this[int index] { get; }

        /// <summary>
        /// Translates the <see cref="IControlledCollection{T}"/> into a flat <see cref="System.Array"/>
        ...
        /// instance to find within the <see cref="IControlledCollection{T}"/>.</param>
        /// <returns>-1 if the <paramref name="element"/> was not found within
        /// the <see cref="IControlledCollection{T}"/>; a positive <see cref="Int32"/>
