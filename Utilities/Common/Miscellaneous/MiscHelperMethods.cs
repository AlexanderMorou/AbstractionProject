                                ...
                                for (int n = start3; n < end3; n += step6)
                                    for (int o = start4; o < end4; o += step7)
                                        for (int p = start4; p < end4; p += step8)
                                            yield return new Tuple<int, int, int, int, int, int, int, int>(i, j, k, l, m, n, o, p);
        }
