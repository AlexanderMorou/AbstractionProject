...
namespace AllenCopeland.Abstraction.Utilities.Tuples
{
    // Module: RootModule
    /// <summary>
    /// Represents a 11-tuple, or undecuple.
    /// </summary>
        ...
        Tuple<T1, T2, T3, T4, T5, T6, T7, Tuple<T8, T9, T10, T11>>
    {
        ...
        public Tuple(T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7, T8 item8, T9 item9, T10 item10, T11 item11)
             : base(item1, item2, item3, 
                    item4, item5, item6, 
                    item7, new Tuple<T8, T9, T10, T11>(item8, item9, item10, 
                        item11))
        {
        }
