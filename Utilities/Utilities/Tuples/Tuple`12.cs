...
namespace AllenCopeland.Abstraction.Utilities.Tuples
{
    // Module: RootModule
    /// <summary>
    /// Represents a 12-tuple, or duodecuple.
    /// </summary>
        ...
        Tuple<T1, T2, T3, T4, T5, T6, T7, Tuple<T8, T9, T10, T11, T12>>
    {
        ...
        public Tuple(T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7, T8 item8, T9 item9, T10 item10, T11 item11, T12 item12)
             : base(item1, item2, item3, 
                    item4, item5, item6, 
                    item7, new Tuple<T8, T9, T10, T11, T12>(item8, item9, item10, 
                        item11, item12))
        {
        }
 ...
 /* ------------------------------------------------------------\
 |  This file took 00:00:00.0003781 to generate.                |
 |  Date generated: 8/31/2011 11:53:54 AM                       |
 |  There were 14 types used by this file                       |
 |  1, 10, 11, 12, 2, 3, 4, 5, 6, 7, 8, 9,                      |
 |  <T1,T2,T3,T4,T5,T6,T7,System.Tuple`5<T8,T9,T10,T11,T12>>,   |
 |  Tuple`5<T8,T9,T10,T11,T12>                                  |
 |--------------------------------------------------------------|
