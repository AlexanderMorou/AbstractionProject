...
namespace AllenCopeland.Abstraction.Utilities.Collections
{
    ...
    public static partial class GeneralExtensions
    {
        ...
        public static ParallelQuery<int> ParallelRangeTo(this int source, int exclusiveTo)
        {
            return source.RangeTo(exclusiveTo).AsParallel();
        }
        ...
        public static IEnumerable<T> Shuffle<T>(this IEnumerable<T> target, int seedA, int seedB)
        {
            Random firstRandomShuffler = new Random(seedA);
            Random secondRandomShuffler = new Random(seedB);
            return from t in target
                   orderby firstRandomShuffler.Next() ^ t.GetHashCode() descending,
                           secondRandomShuffler.Next() ascending
                   select t;
        }
        ...
        internal static ControlledDictionary<TKey, TValue> InternalCast<TKey, TValue>(this IControlledDictionary<TKey, TValue> knownInternalDictionary)
        {
            return (ControlledDictionary<TKey, TValue>)knownInternalDictionary;
        }
