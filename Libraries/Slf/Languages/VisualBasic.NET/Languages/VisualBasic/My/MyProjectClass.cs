...
namespace AllenCopeland.Abstraction.Slf.Languages.VisualBasic.My
{
        ...
        IMyProjectClass
    {
        ...
        {
            get { return (IIntermediatePropertyMember)this.GetProperty("Application"); }
        }

        public IIntermediatePropertyMember Computer
        {
            get { return (IIntermediatePropertyMember)this.GetProperty("Computer"); }
        }

        public IIntermediatePropertyMember WebServices
        {
            get { return (IIntermediatePropertyMember)this.GetProperty("WebServices"); }
        }
