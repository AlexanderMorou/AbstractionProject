...
namespace AllenCopeland.Abstraction.Slf.Languages.CSharp.Translation
{
    partial class CSharpProjectTranslator
    {
            ...
            IIntermediateCodeNameProvider
        {
            ...
            public string Visit<TCoercionParent, TIntermediateCoercionParent>(IIntermediateTypeCoercionMember<TCoercionParent, TIntermediateCoercionParent> intermediateMember, IntermediateNameRequestDetails context)
                where TCoercionParent : Abstract.ICoercibleType<Abstract.Members.ITypeCoercionUniqueIdentifier, Abstract.Members.ITypeCoercionMember<TCoercionParent>, TCoercionParent>
                where TIntermediateCoercionParent : IIntermediateCoercibleType<Abstract.Members.ITypeCoercionUniqueIdentifier, Abstract.Members.ITypeCoercionMember<TCoercionParent>, IIntermediateTypeCoercionMember<TCoercionParent, TIntermediateCoercionParent>, TCoercionParent, TIntermediateCoercionParent>, TCoercionParent
            {
                string name = null;
                switch (context)
                {
                    case IntermediateNameRequestDetails.TargetFileName:
                        if (this.HtmlContext)
                            name = string.Format("#typCoer{0:X8}", intermediateMember.GetHashCode());
                        break;
                    case IntermediateNameRequestDetails.DisplayName:
                        name = intermediateMember.Name;
                        break;
