...
namespace AllenCopeland.Abstraction.Slf.Translation
{
    ...
    public interface IIntermediateCodeTranslatorOptions
    {
        ...
        /// </summary>
        bool EmitGenerationTime { get; set; }

        /// <summary>
        /// Returns/sets whether the translator should shorten really long filenames and use elipses in place of the replaced portion.
        /// </summary>
        bool ShortenFilenames { get; set; }
        ...
        /// </summary>
        byte? IndentationSpaceCount { get; set; }
    }
}
