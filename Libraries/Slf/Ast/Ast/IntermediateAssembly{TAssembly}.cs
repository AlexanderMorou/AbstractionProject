...
namespace AllenCopeland.Abstraction.Slf.Ast
{
            ...
            IIntermediateIdentityManager
    {
        ...
        public string FileName { get { return this._fileName ?? DefaultAssemblyFilenameVisitor.GetFileInfo(this); } set { this._fileName = value; } }

        public bool UsesDefaultFileName { get { return this._fileName == null; } }
        ...
        protected override IAssemblyUniqueIdentifier OnGetUniqueIdentifier()
        {
            ...
            if (this.IsRoot)
            {
                if (this.uniqueIdentifier == null)
                {
                    var service = this.GetUniqueIdentifierService();
                    this.uniqueIdentifier = service.HandlesAssemblyIdentifier
