...
namespace AllenCopeland.Abstraction.Slf.Ast.Statements
{
  ...
  /// Denotes the type of result the members of the <see cref="AllenCopeland.Abstraction.Slf.Ast.Statements.IStatementVisitor{TResult,TContext}"/>
  /// should yield.
  /// </typeparam>
  /// <typeparam name="TContext">
  /// Denotes the type of context the members of the <see cref="AllenCopeland.Abstraction.Slf.Ast.Statements.IStatementVisitor{TResult,TContext}"/>
  ...
  public interface IStatementVisitor<TResult, TContext>
  {
    ...
    /// of the visitor.
    /// </returns>
    TResult Visit(IExplicitStringLiteralStatement statement, TContext context);
    /// <summary>
    /// Returns a <typeparamref name="TResult"/> after it visits the <paramref name="statement"/>
    /// provided with the given <paramref name="context"/>.
    /// </summary>
    ...
    /// of the visitor.
    /// </returns>
    TResult Visit(IIterationDeclarationBlockStatement statement, TContext context);
    /// <summary>
    /// Returns a <typeparamref name="TResult"/> after it visits the <paramref name="statement"/>
    /// provided with the given <paramref name="context"/>.
    /// </summary>
    ...
    /// of the visitor.
    /// </returns>
    TResult Visit(IWhileStatement statement, TContext context);
    /// <summary>
    /// Returns a <typeparamref name="TResult"/> after it visits the <paramref name="statement"/>
    /// provided with the given <paramref name="context"/>.
    /// </summary>
