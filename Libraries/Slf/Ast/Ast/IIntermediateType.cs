...
namespace AllenCopeland.Abstraction.Slf.Ast
{
        ...
        IType
    {
        ...
        /// </summary>
#if DEBUG
        [VisitorPropertyRequirement("HasMembers")]
#endif
        ...
        void Accept(IIntermediateTypeVisitor visitor);
        /// <summary>
        /// Visits the <paramref name="visitor"/> provided.
        /// </summary>
        /// <param name="visitor">The <see cref="IIntermediateTypeVisitor"/> to
        ...
        TResult Accept<TResult, TContext>(IIntermediateTypeVisitor<TResult, TContext> visitor, TContext context);
        /// <summary>
