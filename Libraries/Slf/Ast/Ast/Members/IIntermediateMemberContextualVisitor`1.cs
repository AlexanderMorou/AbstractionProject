...
{
  /// <summary>
  /// Represents a basic visitor for intermediate members which has a <typeparamref name="TContext"/>
  /// relevant to the visit.
  /// </summary>
  /// <typeparam name="TContext">
  /// Denotes the type of context the members of the <see cref="AllenCopeland.Abstraction.Slf.Ast.Members.IIntermediateMemberContextualVisitor{TContext}"/>
  /// should receive along with the types that accept the visitor.
  /// </typeparam>
  public interface IIntermediateMemberContextualVisitor<TContext>
  {
    /// <summary>
    /// Visits the <paramref name="intermediateMember"/> provided with the given <paramref name="context"/>.
    /// </summary>
    ...
    /// </param>
    void Visit(ILinqRangeVariable intermediateMember, TContext context);
    /// <summary>
    /// Visits the <paramref name="intermediateMember"/> provided with the given <paramref name="context"/>.
    /// </summary>
    /// <param name="intermediateMember">
    ...
    /// The <typeparamref name="TContext"/> relevant to the visit.
    /// </param>
    void Visit(ILinqTypedRangeVariable intermediateMember, TContext context);
    /// <summary>
    /// Visits the <paramref name="intermediateMember"/> provided with the given <paramref name="context"/>.
    /// </summary>
    /// <param name="intermediateMember">
    ...
    /// The <typeparamref name="TContext"/> relevant to the visit.
    /// </param>
    void Visit<TCoercionParent, TIntermediateCoercionParent>(IIntermediateBinaryOperatorCoercionMember<TCoercionParent, TIntermediateCoercionParent> intermediateMember, TContext context)
    ...
    /// The <typeparamref name="TContext"/> relevant to the visit.
    /// </param>
    void Visit<TCtor, TIntermediateCtor, TType, TIntermediateType>(IIntermediateConstructorMember<TCtor, TIntermediateCtor, TType, TIntermediateType> intermediateMember, TContext context)
      where TCtor:
    ...
    /// The <typeparamref name="TContext"/> relevant to the visit.
    /// </param>
    void Visit<TCtor, TIntermediateCtor, TType, TIntermediateType>(IIntermediateConstructorSignatureMember<TCtor, TIntermediateCtor, TType, TIntermediateType> intermediateMember, TContext context)
      where TCtor:
        IConstructorMember<TCtor, TType>
      where TIntermediateCtor:
        TCtor,
    ...
    /// The <typeparamref name="TContext"/> relevant to the visit.
    /// </param>
    void Visit(IIntermediateEnumFieldMember intermediateMember, TContext context);
    /// <summary>
    /// Visits the <paramref name="intermediateMember"/> provided with the given <paramref name="context"/>.
    /// </summary>
    /// <param name="intermediateMember">
    ...
    /// The <typeparamref name="TContext"/> relevant to the visit.
    /// </param>
    void Visit<TEvent, TIntermediateEvent, TEventParent, TIntermediateEventParent>(IIntermediateEventMember<TEvent, TIntermediateEvent, TEventParent, TIntermediateEventParent> intermediateMember, TContext context)
      where TEvent:
    ...
    /// The <typeparamref name="TContext"/> relevant to the visit.
    /// </param>
    void Visit<TEvent, TIntermediateEvent, TEventParent, TIntermediateEventParent>(IIntermediateEventSignatureMember<TEvent, TIntermediateEvent, TEventParent, TIntermediateEventParent> intermediateMember, TContext context)
      where TEvent:
    ...
    /// The <typeparamref name="TContext"/> relevant to the visit.
    /// </param>
    void Visit<TField, TIntermediateField, TFieldParent, TIntermediateFieldParent>(IIntermediateFieldMember<TField, TIntermediateField, TFieldParent, TIntermediateFieldParent> intermediateMember, TContext context)
      where TField:
    ...
    /// The <typeparamref name="TContext"/> relevant to the visit.
    /// </param>
    void Visit<TIndexer, TIntermediateIndexer, TIndexerParent, TIntermediateIndexerParent>(IIntermediateIndexerMember<TIndexer, TIntermediateIndexer, TIndexerParent, TIntermediateIndexerParent> intermediateMember, TContext context)
      where TIndexer:
    ...
    /// The <typeparamref name="TContext"/> relevant to the visit.
    /// </param>
    void Visit<TIndexer, TIntermediateIndexer, TIndexerParent, TIntermediateIndexerParent>(IIntermediateIndexerSignatureMember<TIndexer, TIntermediateIndexer, TIndexerParent, TIntermediateIndexerParent> intermediateMember, TContext context)
      where TIndexer:
    ...
    /// The <typeparamref name="TContext"/> relevant to the visit.
    /// </param>
    void Visit<TMethod, TIntermediateMethod, TMethodParent, TIntermediateMethodParent>(IIntermediateMethodMember<TMethod, TIntermediateMethod, TMethodParent, TIntermediateMethodParent> intermediateMember, TContext context)
      where TMethod:
    ...
    /// The <typeparamref name="TContext"/> relevant to the visit.
    /// </param>
    void Visit<TSignature, TIntermediateSignature, TParent, TIntermediateParent>(IIntermediateMethodSignatureMember<TSignature, TIntermediateSignature, TParent, TIntermediateParent> intermediateMember, TContext context)
      where TSignature:
    ...
    /// The <typeparamref name="TContext"/> relevant to the visit.
    /// </param>
    void Visit<TParent, TIntermediateParent>(IIntermediateParameterMember<TParent, TIntermediateParent> intermediateMember, TContext context)
      where TParent:
        IParameterParent
      where TIntermediateParent:
        TParent,
    ...
    /// The <typeparamref name="TContext"/> relevant to the visit.
    /// </param>
    void Visit<TProperty, TIntermediateProperty, TPropertyParent, TIntermediatePropertyParent>(IIntermediatePropertyMember<TProperty, TIntermediateProperty, TPropertyParent, TIntermediatePropertyParent> intermediateMember, TContext context)
      where TProperty:
    ...
    /// The <typeparamref name="TContext"/> relevant to the visit.
    /// </param>
    void Visit<TProperty, TIntermediateProperty, TPropertyParent, TIntermediatePropertyParent>(IIntermediatePropertySignatureMember<TProperty, TIntermediateProperty, TPropertyParent, TIntermediatePropertyParent> intermediateMember, TContext context)
      where TProperty:
    ...
    /// The <typeparamref name="TContext"/> relevant to the visit.
    /// </param>
    void Visit<TCoercionParent, TIntermediateCoercionParent>(IIntermediateTypeCoercionMember<TCoercionParent, TIntermediateCoercionParent> intermediateMember, TContext context)
      where TCoercionParent:
    ...
    /// The <typeparamref name="TContext"/> relevant to the visit.
    /// </param>
    void Visit<TCoercionParent, TInterCoercionParent>(IIntermediateUnaryOperatorCoercionMember<TCoercionParent, TInterCoercionParent> intermediateMember, TContext context)
      where TCoercionParent:
    ...
    /// The <typeparamref name="TContext"/> relevant to the visit.
    /// </param>
    void Visit(ILocalMember intermediateMember, TContext context);
  };
};
