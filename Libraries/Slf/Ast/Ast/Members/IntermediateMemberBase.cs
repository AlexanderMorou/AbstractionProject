...
namespace AllenCopeland.Abstraction.Slf.Ast.Members
{
            ...
            TParent
    {
        ...
        /// <summary>
        /// Returns/sets the <see cref="String"/> value which denotes language specific information about how to
        /// uniquely qualify the <see cref="IntermediateMemberBase{TIdentifier, TParent, TIntermediateParent}"/>.
        /// </summary>
        public string UserSpecificQualifier
        {
            get
            {
                return this._languageSpecificQualifier;
            }
            set
            {
