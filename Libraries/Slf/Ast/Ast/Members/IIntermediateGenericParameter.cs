...
namespace AllenCopeland.Abstraction.Slf.Ast.Members
{
            ...
            IIntermediateGenericParameter<TGenericParameter, TIntermediateGenericParameter>
    {
        ...
        /// </summary>
#if DEBUG
        [VisitorPropertyRequirement("HasConstructors")]
#endif
        ...
        /// </summary>
#if DEBUG
        [VisitorPropertyRequirement("HasMethods")]
#endif
        ...
        /// </summary>
#if DEBUG
        [VisitorPropertyRequirement("HasProperties")]
#endif
    ...
    /// </summary>
#if DEBUG
    [VisitorImplementationGroupPropertiesAttribute(GroupId = "IntermediateGenericParameter", PropertyNames = new string[] { "Constructors", "Events", "Indexers", "Methods", "Properties" }, HandleItemsAsGroup = true)]
#endif
