...
namespace AllenCopeland.Abstraction.Slf.Ast
{
  ...
  /// Denotes the type of result the members of the <see cref="AllenCopeland.Abstraction.Slf.Ast.IIntermediateTypeVisitor{TResult,TContext}"/>
  /// should yield.
  /// </typeparam>
  /// <typeparam name="TContext">
  /// Denotes the type of context the members of the <see cref="AllenCopeland.Abstraction.Slf.Ast.IIntermediateTypeVisitor{TResult,TContext}"/>
  ...
  public interface IIntermediateTypeVisitor<TResult, TContext>
  {
    ...
    /// of the visitor.
    /// </returns>
    TResult Visit(IIntermediateClassType intermediateType, TContext context);
    /// <summary>
    /// Returns a <typeparamref name="TResult"/> after it visits the <paramref name="intermediateType"/>
    /// provided with the given <paramref name="context"/>.
    /// </summary>
    ...
    /// of the visitor.
    /// </returns>
    TResult Visit(IIntermediateDelegateType intermediateType, TContext context);
    /// <summary>
    /// Returns a <typeparamref name="TResult"/> after it visits the <paramref name="intermediateType"/>
    /// provided with the given <paramref name="context"/>.
    /// </summary>
    ...
    /// of the visitor.
    /// </returns>
    TResult Visit(IIntermediateEnumType intermediateType, TContext context);
    /// <summary>
    /// Returns a <typeparamref name="TResult"/> after it visits the <paramref name="intermediateType"/>
    /// provided with the given <paramref name="context"/>.
    /// </summary>
    ...
    /// of the visitor.
    /// </returns>
    TResult Visit(IIntermediateInterfaceType intermediateType, TContext context);
    /// <summary>
    /// Returns a <typeparamref name="TResult"/> after it visits the <paramref name="intermediateType"/>
    /// provided with the given <paramref name="context"/>.
    /// </summary>
    ...
    /// of the visitor.
    /// </returns>
    TResult Visit(IIntermediateStructType intermediateType, TContext context);
    /// <summary>
    /// Returns a <typeparamref name="TResult"/> after it visits the <paramref name="intermediateType"/>
    /// provided with the given <paramref name="context"/>.
    /// </summary>
    ...
    /// of the visitor.
    /// </returns>
    TResult Visit<TGenericParameter, TIntermediateGenericParameter, TParent, TIntermediateParent>(IIntermediateGenericParameter<TGenericParameter, TIntermediateGenericParameter, TParent, TIntermediateParent> intermediateType, TContext context)
