...
namespace AllenCopeland.Abstraction.Slf.Ast
{
    ...
    /// </summary>
#if DEBUG
    [VisitorTargetAttribute("IntermediateDeclarationVisitor", ContextualVisitor = true)]
    [VisitorTargetAttribute("IntermediateDeclarationVisitor", YieldingVisitor = true)]
    [VisitorTargetAttribute("IntermediateDeclarationVisitor", ContextualVisitor = true,
                                                       YieldingVisitor    = true)]
    [VisitorTargetAttribute("IntermediateDeclarationVisitor")]
    [VisitorTargetAttribute("IntermediateTreeVisitor", DerivedThroughInheriting = "IntermediateDeclarationVisitor")]
#endif
        ...
        IAssembly
    {
        ...
        void Accept(IIntermediateDeclarationVisitor visitor);
        /// <summary>
        /// Visits the <paramref name="visitor"/> provided.
        /// </summary>
        ...
        TResult Accept<TResult, TContext>(IIntermediateDeclarationVisitor<TResult, TContext> visitor, TContext context);
        /// <summary>
        ...
        /// <summary>Returns whether the <see cref="FileName"/> of the <see cref="IIntermediateAssembly"/> is the default.</summary>
        bool UsesDefaultFileName { get; }
    }
}
