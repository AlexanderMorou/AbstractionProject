...
#endif
    public interface IExplicitStringLiteralDecorationExpression :
        IDecorationExpression
    {
        /// <summary>
        /// Returns/sets the <see cref="String"/> value to insert directly into the code.
        /// </summary>
        string LiteralInsert { get; set; }
    }
}
