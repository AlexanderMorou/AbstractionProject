...
namespace AllenCopeland.Abstraction.Slf.Ast.Expressions
{
...
#endif
    public interface IAwaitExpression :
    ...
    {
        /// <summary>
        /// The contractually awaited expression that's expected.
        /// </summary>
        IExpression Proffer { get; set; }
    }
#if DEBUG
    [VisitorTargetAttribute("ExpressionVisitor", ContextualVisitor  = true)]
    [VisitorTargetAttribute("ExpressionVisitor", YieldingVisitor    = true)]
    ...
    [VisitorTargetAttribute("IntermediateTreeVisitor", DerivedThroughInheriting = "IntermediateCodeVisitor")]
#endif
    public interface IAwaitStatementExpression :
        IAwaitExpression,
        IStatementExpression
    {
        ...
        /// The contractually awaited expression that's expected.
        /// </summary>
        new IStatementExpression Proffer { get; set; }
    }
}
