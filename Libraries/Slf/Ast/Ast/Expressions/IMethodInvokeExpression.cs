...
namespace AllenCopeland.Abstraction.Slf.Ast.Expressions
{
        ...
        IStatementExpression
    {
        ...
        /// which identifies the name and type-parameters of the method 
        /// to use as well as the type-signature used for the parameters.
        /// </summary>
        ...
        IMalleableExpressionCollection Arguments { get; }
    }
}