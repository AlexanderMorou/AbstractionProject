...
namespace AllenCopeland.Abstraction.Slf.Ast.Expressions
{
    ...
    {
        /// <summary>
        /// Returns/sets the expression, which is fusable to the comma delimited series of type-references, associated to the 
        /// <see cref="IExpressionToCommaTypeReferenceFusionExpression"/>
        /// </summary>
        IFusionTypeCollectionTargetExpression Left { get; set; }
        /// <summary>
        /// Returns the <see cref="ITypeCollection"/> which represents the type-reference series fused to the <see cref="Left"/> portion
