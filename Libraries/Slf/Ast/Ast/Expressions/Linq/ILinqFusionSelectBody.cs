...
{
    /// <summary>
    /// Defines properties and methods for working with a language integrated query body which acts as
    /// a select body that fuses with another query.
    /// </summary>
#if DEBUG
...
#endif
    public interface ILinqFusionSelectBody :
        ILinqSelectBody,
        ILinqFusionBody,
