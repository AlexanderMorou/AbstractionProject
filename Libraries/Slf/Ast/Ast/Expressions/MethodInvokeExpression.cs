...
namespace AllenCopeland.Abstraction.Slf.Ast.Expressions
{
        ...
        IMethodInvokeExpression
    {
        ...
        /// </summary>
        private IMalleableExpressionCollection arguments;
        /// <summary>
        ...
        public IMalleableExpressionCollection Arguments
        {
            get
            {
                if (this.arguments == null)
                    this.arguments = new MalleableExpressionCollection();
        ...
        public override string ToString()
        {
            ...
            {
                bool first = true;
                foreach (IExpression t in this.Arguments)
                {
                    if (first)
                        first = false;
                    else
