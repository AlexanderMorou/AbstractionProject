...
namespace AllenCopeland.Abstraction.Slf.Ast
{
        ...
        ITypeInclusionScopeCoercion
    {
        ...
        public virtual void Accept(IScopeCoercionVisitor visitor)
        {
            visitor.Visit(this);
        }

        public virtual TResult Accept<TResult, TContext>(IScopeCoercionVisitor<TResult, TContext> visitor, TContext context)
        {
