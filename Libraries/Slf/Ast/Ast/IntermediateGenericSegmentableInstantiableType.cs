...
namespace AllenCopeland.Abstraction.Slf.Ast
{
            ...
            TIntermediateType
    {
        ...
        protected virtual BinaryOperatorMember GetNewBinaryOperator(CoercibleBinaryOperators op, BinaryOpCoercionContainingSide side, IType returnType)
        {
            var result = new BinaryOperatorMember(this);
            result.Operator = op;
            result.ContainingSide = side;
            result.ReturnType = returnType;
            return result;
        }

        protected virtual TypeCoercionMember GetNewTypeCoercion(TypeConversionRequirement requirement, TypeConversionDirection direction, IType coercionType)
        {
            var result = new TypeCoercionMember((TInstanceIntermediateType)(object)this);
            result.Requirement  = requirement;
            result.Direction    = direction;
            result.CoercionType = coercionType;
            return result;
        }

        protected virtual UnaryOperatorMember GetUnaryOperatorMember(CoercibleUnaryOperators op)
        {
            var result = new UnaryOperatorMember(this);
            result.Operator = op;
            return result;
        }
        ...
        public bool HasIndexers
        {
            get
            {
                return this.indexers != null && this.indexers.Count > 0;
            }
        }

        public bool HasTypeCoercions
        {
            get
            {
                return this.typeCoercions != null && this.typeCoercions.Count > 0;
            }
        }
        ...
        public bool HasBinaryOperatorCoercions
        {
            get
            {
                return this.binaryOperatorCoercions != null && this.binaryOperatorCoercions.Count > 0;
            }
        }
        public bool HasUnaryOperatorCoercions
        {
            get
            {
                return this.unaryOperatorCoercions != null && this.unaryOperatorCoercions.Count > 0;
            }
        }
