...
#if DEBUG
    [VisitorImplementationGroupPropertiesAttribute(GroupId = "IntermediateInstantiable", PropertyNames = new[] { "BinaryOperatorCoercions", "Constructors", "Events", "Fields", "Indexers", "Methods", "Properties", "TypeCoercions", "UnaryOperatorCoercions" }, HandleItemsAsGroup = true)]
#endif
