...
namespace AllenCopeland.Abstraction.Slf._Internal.Cli.Metadata.Tables
{
        ...
        ICilInstructionVisitor
    {
        ...
        {
            this.instructions.Add(new LocalReferenceStackInstruction(CilOpcodeInstruction.LoadLocal0, instructionOffset, this));
        }

        public void VisitLoadLocal1(int instructionOffset)
        {
            this.instructions.Add(new LocalReferenceStackInstruction(CilOpcodeInstruction.LoadLocal1, instructionOffset, this));
        }

        public void VisitLoadLocal2(int instructionOffset)
        {
            this.instructions.Add(new LocalReferenceStackInstruction(CilOpcodeInstruction.LoadLocal2, instructionOffset, this));
        }

        public void VisitLoadLocal3(int instructionOffset)
        {
            this.instructions.Add(new LocalReferenceStackInstruction(CilOpcodeInstruction.LoadLocal3, instructionOffset, this));
        }
        ...
        {
            if (this.owner.Signature.ReturnType.TypeSignatureKind == Slf.Cli.Metadata.Blobs.CliMetadataTypeSignatureKind.NativeType)
            {
                var nativeReturn = (ICliMetadataNativeTypeSignature)this.owner.Signature.ReturnType;
                if (nativeReturn.TypeKind == CliMetadataNativeTypes.Void)
                    this.instructions.Add(new ReturnStackInstruction(true, instructionOffset));
            }
            this.instructions.Add(new ReturnStackInstruction(false, instructionOffset));
        }
        ...
        {
            this.instructions.Add(new LocalReferenceStackInstruction(CilOpcodeInstruction.StoreLocal0, instructionOffset, this));
        }

        public void VisitStoreLocal1(int instructionOffset)
        {
            this.instructions.Add(new LocalReferenceStackInstruction(CilOpcodeInstruction.StoreLocal1, instructionOffset, this));
        }

        public void VisitStoreLocal2(int instructionOffset)
        {
            this.instructions.Add(new LocalReferenceStackInstruction(CilOpcodeInstruction.StoreLocal2, instructionOffset, this));
        }

        public void VisitStoreLocal3(int instructionOffset)
        {
            this.instructions.Add(new LocalReferenceStackInstruction(CilOpcodeInstruction.StoreLocal3, instructionOffset, this));
        }
        ...
        {
            this.instructions.Add(new LocalReferenceStackInstruction<byte>(CilOpcodeInstruction.LoadLocalAddressShortForm, instructionOffset, value, this));
        }

        public void VisitLoadLocalShortForm(byte value, int instructionOffset)
        {
            this.instructions.Add(new LocalReferenceStackInstruction<byte>(CilOpcodeInstruction.LoadLocalShortForm, instructionOffset, value, this));
        }
        ...
        {
            this.instructions.Add(new LocalReferenceStackInstruction<byte>(CilOpcodeInstruction.StoreLocalShortForm, instructionOffset, value, this));
        }
        ...
        {
            this.instructions.Add(new BranchInstruction8(CilOpcodeInstruction.BranchIfGreaterThanOrEqualToShortForm, instructionOffset, relativeInstructionOffset));
        }
        ...
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.AddressCopy, instructionOffset, targetMetadataRow));
        }

        public void VisitBox(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.Box, instructionOffset, targetMetadataRow));
        }

        public void VisitCallMethod(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.CallMethod, instructionOffset, targetMetadataRow));
        }

        public void VisitCallMethodIndirect(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.CallMethodIndirect, instructionOffset, targetMetadataRow));
        }

        public void VisitCallVirtualMethod(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.CallVirtualMethod, instructionOffset, targetMetadataRow));
        }

        public void VisitCastClass(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.CastClass, instructionOffset, targetMetadataRow));
        }

        public void VisitGetTypedReferenceAddress(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.GetTypedReferenceAddress, instructionOffset, targetMetadataRow));
        }

        public void VisitIsInstance(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.IsInstance, instructionOffset, targetMetadataRow));
        }

        public void VisitJumpTo(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.JumpTo, instructionOffset, targetMetadataRow));
        }

        public void VisitLoadArrayElementAddress(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.LoadArrayElementAddress, instructionOffset, targetMetadataRow));
        }

        public void VisitLoadElement(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.LoadElement, instructionOffset, targetMetadataRow));
        }

        public void VisitLoadField(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.LoadField, instructionOffset, targetMetadataRow));
        }

        public void VisitLoadFieldAddress(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.LoadFieldAddress, instructionOffset, targetMetadataRow));
        }

        public void VisitLoadObject(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.LoadObject, instructionOffset, targetMetadataRow));
        }

        public void VisitLoadStaticField(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.LoadStaticField, instructionOffset, targetMetadataRow));
        }

        public void VisitLoadStaticFieldAddress(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.LoadStaticFieldAddress, instructionOffset, targetMetadataRow));
        }

        public void VisitLoadToken(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.LoadToken, instructionOffset, targetMetadataRow));
        }

        public void VisitMakeTypedReference(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.MakeTypedReference, instructionOffset, targetMetadataRow));
        }

        public void VisitNewArray(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.NewArray, instructionOffset, targetMetadataRow));
        }

        public void VisitNewObject(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.NewObject, instructionOffset, targetMetadataRow));
        }

        public void VisitStoreElement(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.StoreElement, instructionOffset, targetMetadataRow));
        }

        public void VisitStoreField(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.StoreField, instructionOffset, targetMetadataRow));
        }

        public void VisitStoreObject(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.StoreObject, instructionOffset, targetMetadataRow));
        }

        public void VisitStoreStaticField(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.StoreStaticField, instructionOffset, targetMetadataRow));
        }

        public void VisitUnbox(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.Unbox, instructionOffset, targetMetadataRow));
        }

        public void VisitUnboxAny(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.UnboxAny, instructionOffset, targetMetadataRow));
        }
        ...
        {
            this.instructions.Add(new LocalReferenceStackInstruction<short>(CilOpcodeInstruction.LoadLocal, instructionOffset, index, this));
        }

        public void VisitLoadLocalAddress(short index, int instructionOffset)
        {
            this.instructions.Add(new LocalReferenceStackInstruction<short>(CilOpcodeInstruction.LoadLocalAddress, instructionOffset, index, this));
        }
        ...
        {
            this.instructions.Add(new LocalReferenceStackInstruction<short>(CilOpcodeInstruction.StoreLocal, instructionOffset, index, this));
        }

        public void VisitConstrainedCallVirtModifier(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.ConstrainedCallVirtModifier, instructionOffset, targetMetadataRow));
        }

        public void VisitInitializeObject(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.InitializeObject, instructionOffset, targetMetadataRow));
        }

        public void VisitLoadMethodPointer(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.LoadMethodPointer, instructionOffset, targetMetadataRow));
        }

        public void VisitLoadVirtualMethodPointer(ICliMetadataTableRow targetMetadataRow, int instructionOffset)
        {
            this.instructions.Add(new ReferenceInstruction(CilOpcodeInstruction.LoadVirtualMethodPointer, instructionOffset, targetMetadataRow));
        }
    }
}
