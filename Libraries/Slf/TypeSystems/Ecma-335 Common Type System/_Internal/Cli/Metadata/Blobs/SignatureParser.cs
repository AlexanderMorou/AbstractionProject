        ...
        parseNextModifier:
            ...
            switch (nextChar)
            {
                case CliMetadataNativeTypes.Pinned:
                    /* This has been known to happen.  C#'s compiler supports understanding constant locals of an enum by specifying a field that is pinned, 
                     * some PDB magic added, and we get nice constant enum value feedback during debugging.  Why it uses pinned, is beyond me, it likely has
                     * some other internal meaning with respect to the debugger. */
                    /* Refer to https://social.msdn.microsoft.com/Forums/en-US/b4252eab-7aae-4456-9829-2707c8459e13/pinned-fields-in-the-common-language-runtime?forum=netfxtoolsdev
                     * For a topic that outlines the discovery. */
                    reader.ReadByte();
                    if (customModifiers == null)
