...
namespace AllenCopeland.Abstraction.Slf.Abstract
{
        ...
        IEquatable<IAssemblyUniqueIdentifier>
    {
        ...
        IGeneralTypeUniqueIdentifier GetTypeIdentifier(string @namespace, string name, string languageSpecificQualifier);
        IGeneralGenericTypeUniqueIdentifier GetTypeIdentifier(string @namespace, string name, int typeParameterCount, string languageSpecificQualifier);
    }
}
