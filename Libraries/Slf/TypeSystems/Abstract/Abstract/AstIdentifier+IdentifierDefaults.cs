...
namespace AllenCopeland.Abstraction.Slf.Abstract
{
    partial class TypeSystemIdentifiers
    {
            ...
            IGeneralDeclarationUniqueIdentifier
        {
            ...
            //#endregion
            public DefaultGeneralDeclarationUniqueIdentifier(string name, string languageSpecificQualifier)
                : this(name)
            {
            ...
            {
                if (this.Name == null)
                    return -101 ^ (string.IsNullOrEmpty(this.LanguageSpecificQualifier) ? 0 : this.LanguageSpecificQualifier.GetHashCode());
                return this.Name.GetHashCode() ^ (string.IsNullOrEmpty(this.LanguageSpecificQualifier) ? 0 : this.LanguageSpecificQualifier.GetHashCode());
            }
            public override string ToString()
            {
                return this.Name;
            }
            public string LanguageSpecificQualifier { get; internal set; }
        }
            ...
            IGeneralGenericTypeUniqueIdentifier
        {
            ...
            public DefaultGenericTypeUniqueIdentifier(string name, int typeParameters, IAssemblyUniqueIdentifier assembly, IGeneralDeclarationUniqueIdentifier @namespace, string languageSpecificQualifier)
                : this(name, typeParameters, assembly, @namespace)
            {
                this.LanguageSpecificQualifier = languageSpecificQualifier;
            }
            public DefaultGenericTypeUniqueIdentifier(string name, IAssemblyUniqueIdentifier assembly, IGeneralDeclarationUniqueIdentifier @namespace, string languageSpecificQualifier)
                : this(name, assembly, @namespace)
            {
                this.LanguageSpecificQualifier = languageSpecificQualifier;
            }
            public DefaultGenericTypeUniqueIdentifier(string name, int typeParameters, IGeneralTypeUniqueIdentifier parent, IGeneralDeclarationUniqueIdentifier @namespace, string languageSpecificQualifier)
                : this(name, typeParameters, parent, @namespace)
            {
                this.LanguageSpecificQualifier = languageSpecificQualifier;
            }
            public DefaultGenericTypeUniqueIdentifier(string name, IGeneralTypeUniqueIdentifier parent, IGeneralDeclarationUniqueIdentifier @namespace, string languageSpecificQualifier)
                : this(name, parent, @namespace)
            {
                this.LanguageSpecificQualifier = languageSpecificQualifier;
            }
            ...
            if (oAssem == null && tAssem != null ||
                    ...
                    return false;
                if (tAssem == null)
                    return other.TypeParameters == this.TypeParameters && other.Name == this.Name && other.LanguageSpecificQualifier == this.LanguageSpecificQualifier;
                else
                    return other.TypeParameters == this.TypeParameters && other.Name == this.Name && tAssem.Equals(oAssem) && other.LanguageSpecificQualifier == this.LanguageSpecificQualifier;
            }
            ...
            {
                if (this.Name == null)
                    return -33 ^ this.TypeParameters ^ (this.UsesNonstandardGraveAccentElement ? 0x40 : 0x00) ^ (string.IsNullOrEmpty(this.LanguageSpecificQualifier) ? 0 : this.LanguageSpecificQualifier.GetHashCode());
                else
                    return this.Name.GetHashCode() ^ this.TypeParameters ^ (this.UsesNonstandardGraveAccentElement ? 0x40 : 0x00) ^ (string.IsNullOrEmpty(this.LanguageSpecificQualifier) ? 0 : this.LanguageSpecificQualifier.GetHashCode());
            }
            ...
            public IGeneralTypeUniqueIdentifier GetNestedIdentifier(string name, string languageSpecificQualifier)
            {
                var result = this.GetNestedIdentifier(name);
                if (result is DefaultTypeUniqueIdentifier)
                    ((DefaultTypeUniqueIdentifier)(result)).LanguageSpecificQualifier = languageSpecificQualifier;
                else if (result is DefaultGenericTypeUniqueIdentifier)
                    ((DefaultGenericTypeUniqueIdentifier)(result)).LanguageSpecificQualifier = languageSpecificQualifier;
                return result;
            }
            public IGeneralGenericTypeUniqueIdentifier GetNestedIdentifier(string name, int typeParameterCount, string languageSpecificQualifier)
            {
                var result = GetNestedIdentifier(name, typeParameterCount);
                ((DefaultGenericTypeUniqueIdentifier)(result)).LanguageSpecificQualifier = languageSpecificQualifier;
                return result;
            }
            public IGeneralTypeUniqueIdentifier GetNestedIdentifier(string name, IGeneralDeclarationUniqueIdentifier @namespace, string languageSpecificQualifier)
            {
                var result = GetNestedIdentifier(name, @namespace);
                if (result is DefaultTypeUniqueIdentifier)
                    ((DefaultTypeUniqueIdentifier)(result)).LanguageSpecificQualifier = languageSpecificQualifier;
                else if (result is DefaultGenericTypeUniqueIdentifier)
                    ((DefaultGenericTypeUniqueIdentifier)(result)).LanguageSpecificQualifier = languageSpecificQualifier;
            ...
            public IGeneralGenericTypeUniqueIdentifier GetNestedIdentifier(string name, int typeParameterCount, IGeneralDeclarationUniqueIdentifier @namespace, string languageSpecificQualifier)
            {
                var result = GetNestedIdentifier(name, typeParameterCount, @namespace);
                ((DefaultGenericTypeUniqueIdentifier)(result)).LanguageSpecificQualifier = languageSpecificQualifier;
                return result;
            }
            ...
            IGeneralTypeUniqueIdentifier
        {
            ...
            public bool Equals(IGeneralTypeUniqueIdentifier other)
            {
                if (other == null)
                    return false;
                return other.Name == this.Name && other.LanguageSpecificQualifier == this.LanguageSpecificQualifier;
            }
            ...
            public DefaultTypeUniqueIdentifier(string name, IGeneralTypeUniqueIdentifier parentIdentifier, string languageSpecificQualifier)
                : this(name, parentIdentifier)
            {
                this.LanguageSpecificQualifier = languageSpecificQualifier;
            }
            public DefaultTypeUniqueIdentifier(string name, IAssemblyUniqueIdentifier assembly, IGeneralDeclarationUniqueIdentifier @namespace, string languageSpecificQualifier)
                : this(name, assembly, @namespace)
            {
                this.LanguageSpecificQualifier = languageSpecificQualifier;
            }
            public DefaultTypeUniqueIdentifier(string name, IGeneralTypeUniqueIdentifier parentIdentifier, IGeneralDeclarationUniqueIdentifier @namespace, string languageSpecificQualifier)
                : this(name, parentIdentifier, @namespace)
            {
                this.LanguageSpecificQualifier = languageSpecificQualifier;
            }
            ...
            IGeneralMemberUniqueIdentifier
        {
            ...
            //#endregion
            public DefaultMemberUniqueIdentifier(string name, string languageSpecificQualifier)
                : this(name)
            {
                this.LanguageSpecificQualifier = languageSpecificQualifier;
            }
            ...
            public override string ToString()
            {
                if (this.LanguageSpecificQualifier == null)
                    ...
                    return string.Format("{0} ({1})", this.Name, this.LanguageSpecificQualifier);
            }
            public string LanguageSpecificQualifier { get; internal set; }
        }
            ...
            IGenericParameterUniqueIdentifier
        {
            ...
            public DefaultGenericParameterUniqueIdentifier(string name, bool onType, IAssembly assembly = null, string languageSpecificQualifier = null)
            {
                this.Name = name;
            ...
            public DefaultGenericParameterUniqueIdentifier(int index, string name, bool onType, IAssembly assembly = null, string languageSpecificQualifier = null)
            {
                this.Position = index;
                this.Name = name;
                this.IsTypeParameter = onType;
            ...
            public DefaultGenericParameterUniqueIdentifier(int index, bool onType, IAssembly assembly = null, string languageSpecificQualifier = null)
            {
                this.Position = index;
                this.IsTypeParameter = onType;
                this.LanguageSpecificQualifier = languageSpecificQualifier;
            ...
            public bool Equals(IGenericParameterUniqueIdentifier other)
            {
                ...
                if (other.Position != null && (other.Position == this.Position))
                    return other.IsTypeParameter == this.IsTypeParameter && other.LanguageSpecificQualifier == this.LanguageSpecificQualifier;
                return other.Name == this.Name && other.IsTypeParameter == this.IsTypeParameter && other.LanguageSpecificQualifier == other.LanguageSpecificQualifier;
            }
            ...
            public override int GetHashCode()
            {
                return this.Name.GetHashCode() ^ this.IsTypeParameter.GetHashCode() ^ (string.IsNullOrEmpty(this.LanguageSpecificQualifier) ? 0 : this.LanguageSpecificQualifier.GetHashCode());
            }
            public override string ToString()
            {
                return this.Name;
            ...
            IGeneralMemberUniqueIdentifier
        {
            ...
            public DefaultBinaryOperatorUniqueIdentifier(CoercibleBinaryOperators @operator, BinaryOpCoercionContainingSide containingSide, IType otherSide, string languageSpecificQualifier)
                : this(@operator, containingSide, otherSide)
            {
                this.LanguageSpecificQualifier = languageSpecificQualifier;
            }
                ...
                switch (this.ContainingSide)
                {
                    ...
                    case BinaryOpCoercionContainingSide.RightSide:
                        return other.Operator == this.Operator &&
                               other.ContainingSide == this.ContainingSide && other.LanguageSpecificQualifier == this.LanguageSpecificQualifier;
                    case BinaryOpCoercionContainingSide.Both:
                        return other.Operator == this.Operator &&
                            other.ContainingSide == BinaryOpCoercionContainingSide.Both && other.LanguageSpecificQualifier == this.LanguageSpecificQualifier;
                    default:
                        return false;
                }
            }
                ...
                switch (this.ContainingSide)
                {
                    case BinaryOpCoercionContainingSide.LeftSide:
                        if (this.OtherSide != null)
                            return this.OtherSide.GetHashCode() ^ this.Operator.GetHashCode() ^ this.ContainingSide.GetHashCode() ^ (string.IsNullOrEmpty(this.LanguageSpecificQualifier) ? 0 : this.LanguageSpecificQualifier.GetHashCode());
                        else
                            return -3 ^ this.Operator.GetHashCode() ^ this.ContainingSide.GetHashCode() ^ (string.IsNullOrEmpty(this.LanguageSpecificQualifier) ? 0 : this.LanguageSpecificQualifier.GetHashCode());
                    case BinaryOpCoercionContainingSide.RightSide:
                        if (this.OtherSide != null)
                            return this.OtherSide.GetHashCode() ^ this.Operator.GetHashCode() ^ this.ContainingSide.GetHashCode() ^ (string.IsNullOrEmpty(this.LanguageSpecificQualifier) ? 0 : this.LanguageSpecificQualifier.GetHashCode());
                        else
                            return -2 ^ this.Operator.GetHashCode() ^ this.ContainingSide.GetHashCode() ^ (string.IsNullOrEmpty(this.LanguageSpecificQualifier) ? 0 : this.LanguageSpecificQualifier.GetHashCode());
                    case BinaryOpCoercionContainingSide.Both:
                        return -4 ^ this.Operator.GetHashCode() ^ this.ContainingSide.GetHashCode() ^ (string.IsNullOrEmpty(this.LanguageSpecificQualifier) ? 0 : this.LanguageSpecificQualifier.GetHashCode());
                    default:
                        return -1 ^ this.ContainingSide.GetHashCode() ^ (string.IsNullOrEmpty(this.LanguageSpecificQualifier) ? 0 : this.LanguageSpecificQualifier.GetHashCode());
                }
            }
            ...
            IUnaryOperatorUniqueIdentifier
        {
            ...
            public DefaultUnaryOperatorUniqueIdentifier(CoercibleUnaryOperators @operator, string languageSpecificQualifier)
                : this(@operator)
            {
                this.LanguageSpecificQualifier = languageSpecificQualifier;
            }
            ...
            public bool Equals(IUnaryOperatorUniqueIdentifier other)
            {
                if (other == null)
                    return false;
                return other.Operator == this.Operator && other.LanguageSpecificQualifier == this.LanguageSpecificQualifier;
            }
            ...
            public override int GetHashCode()
            {
                return this.Operator.GetHashCode() ^ (string.IsNullOrEmpty(this.LanguageSpecificQualifier) ? 0 : this.LanguageSpecificQualifier.GetHashCode());
            }
            ...
            IGeneralSignatureMemberUniqueIdentifier
        {
            ...
            public DefaultSignatureMemberUniqueIdentifier(string name, IEnumerable<IType> parameters, string languageSpecificQualifier)
            ...
            public bool Equals(IGeneralSignatureMemberUniqueIdentifier other)
            {
                ...
                if (other.Name != this.Name)
                    return false;
                return other.Parameters.SequenceEqual(this.Parameters) && other.LanguageSpecificQualifier == this.LanguageSpecificQualifier;
            }
            ...
            public override int GetHashCode()
            {
                return ((this.Name == null) ? 0 : this.Name.GetHashCode()) ^ this.ParameterCount ^ (string.IsNullOrEmpty(this.LanguageSpecificQualifier) ? 0 : this.LanguageSpecificQualifier.GetHashCode());
            }
            ...
            ITypeCoercionUniqueIdentifier
        {
            ...
            public bool Equals(ITypeCoercionUniqueIdentifier other)
            {
                if (other == null)
                    return false;
                return other.Direction == this.Direction && other.CoercionType == this.CoercionType && other.Requirement == this.Requirement && other.LanguageSpecificQualifier == this.LanguageSpecificQualifier;
            }
            ...
            public override int GetHashCode()
            {
                if (this.Name != null)
                    if (this.CoercionType != null)
                        return this.Name.GetHashCode() ^ this.Requirement.GetHashCode() ^ this.Direction.GetHashCode() ^ this.CoercionType.GetHashCode() ^ (string.IsNullOrEmpty(this.LanguageSpecificQualifier) ? 0 : this.LanguageSpecificQualifier.GetHashCode());
                    else
                        return this.Name.GetHashCode() ^ this.Requirement.GetHashCode() ^ this.Direction.GetHashCode() ^ -1 ^ (string.IsNullOrEmpty(this.LanguageSpecificQualifier) ? 0 : this.LanguageSpecificQualifier.GetHashCode());
                else
                    if (this.CoercionType != null)
                        return -3 ^ this.Requirement.GetHashCode() ^ this.Direction.GetHashCode() ^ this.CoercionType.GetHashCode() ^ (string.IsNullOrEmpty(this.LanguageSpecificQualifier) ? 0 : this.LanguageSpecificQualifier.GetHashCode());
                    else
                        return -3 ^ this.Requirement.GetHashCode() ^ this.Direction.GetHashCode() ^ -5 ^ (string.IsNullOrEmpty(this.LanguageSpecificQualifier) ? 0 : this.LanguageSpecificQualifier.GetHashCode());
            }

            public DefaultTypeCoercionUniqueIdentifier(TypeConversionRequirement requirement, TypeConversionDirection direction, IType coercionType, string languageSpecificQualifier)
                : this(requirement, direction, coercionType)
            {
                this.LanguageSpecificQualifier = languageSpecificQualifier;
            }
            ...
            IGeneralGenericSignatureMemberUniqueIdentifier
        {
            ...
            {
                return other.TypeParameters == this.TypeParameters && other.Name == this.Name && other.ParameterCount == this.ParameterCount && other.Parameters.SequenceEqual(this.Parameters) && other.LanguageSpecificQualifier == this.LanguageSpecificQualifier;
            }
            ...
            public DefaultGenericSignatureMemberUniqueIdentifier(string name, int typeParameters, IEnumerable<IType> parameters, string languageSpecificQualifier = null)
                : this(name, typeParameters, parameters)
            {
                this.LanguageSpecificQualifier = languageSpecificQualifier;
            }
            ...
            IAssemblyUniqueIdentifier
        {
            ...
            public DefaultAssemblyUniqueIdentifier(string name, IVersion version, ICultureIdentifier cultureIdentifier, string languageSpecificQualifier, byte[] publicKeyToken = null)
                : this(name, version, cultureIdentifier, publicKeyToken)
            {
                this.LanguageSpecificQualifier = languageSpecificQualifier;
            }
            ...
            public virtual bool Equals(IAssemblyUniqueIdentifier other)
            {
                if (this.PublicKeyToken == null && other.PublicKeyToken != null ||
                    ...
                    return other.Name == this.Name && other.Version.Equals(this.Version) && other.Culture == this.Culture && other.LanguageSpecificQualifier == this.LanguageSpecificQualifier;
                else
                    return other.Name == this.Name && other.Version.Equals(this.Version) && other.Culture == this.Culture && other.PublicKeyToken.SequenceEqual(this.PublicKeyToken) && other.LanguageSpecificQualifier == this.LanguageSpecificQualifier;
            }
            ...
            public override int GetHashCode()
            {
                if (this.PublicKeyToken != null)
                {
                    ...
                    return hashResult ^ this.Name.GetHashCode() ^ this.Culture.GetHashCode() ^ this.Version.GetHashCode() ^ (string.IsNullOrEmpty(this.LanguageSpecificQualifier) ? 0 : this.LanguageSpecificQualifier.GetHashCode());
                }
                return this.Name.GetHashCode() ^ this.Culture.GetHashCode() ^ this.Version.GetHashCode() ^ (string.IsNullOrEmpty(this.LanguageSpecificQualifier) ? 0 : this.LanguageSpecificQualifier.GetHashCode());
            }
            ...
            public IGeneralTypeUniqueIdentifier GetTypeIdentifier(string @namespace, string name, string languageSpecificQualifier)
            {
            ...
            public IGeneralGenericTypeUniqueIdentifier GetTypeIdentifier(string @namespace, string name, int typeParameterCount, string languageSpecificQualifier)
            {
                var result = GetTypeIdentifier(@namespace, name, typeParameterCount);
                ((DefaultGenericTypeUniqueIdentifier)(result)).LanguageSpecificQualifier = languageSpecificQualifier;
                return result;
            }
