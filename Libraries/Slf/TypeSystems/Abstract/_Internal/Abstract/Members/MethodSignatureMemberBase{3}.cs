...
namespace AllenCopeland.Abstraction.Slf._Internal.Abstract.Members
{
    ...
    {
        private IMetadataCollection returnTypeMetadata;
        /// <summary>
        ...
        /// is true.
        /// </summary>
        internal ILockedTypeCollection genericParameters;
        ...
        /// <summary>
        /// Returns whether the <see cref="MethodSignatureMemberBase{TSIgnatureParameter, TSignature, TSignatureParent}"/>
        /// can cache the <see cref="Metadata"/>.
        /// </summary>
        ...
        protected abstract IMetadataCollection OnGetReturnMetadata();
            ...
            get
            {
                if (this.CanCacheCustomAttributes)
                {
                    if (this.metadata == null)
                        this.metadata = this.OnGetCustomAttributes();
