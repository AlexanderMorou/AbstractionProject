...
namespace AllenCopeland.Abstraction.Slf._Internal.Ast.Cli
{
        ...
        IIntermediateCliRuntimeEnvironmentInfo
    {
        ...
        internal new void AddResolutionPath(string path)
        {
            base.AddResolutionPath(path);
        }

        internal new bool RemoveResolutionPath(string path)
        {
            return base.RemoveResolutionPath(path);
        }
