...
{
    /// <summary>Provides a base implementation for working with an intermediate delegate defined on top of the Common Language Infrastructure</summary>
    internal class IntermediateCliDelegateType :
        IntermediateDelegateType,
        IIntermediateCliType
    {
        internal protected IntermediateCliDelegateType(string name, IIntermediateTypeParent parent)
            : base(name, parent)
        {
        }
