...
namespace AllenCopeland.Abstraction.Slf.Platforms.WindowsNT
{
    partial struct PEImageExtendedHeader
    {
        ...
        private struct NTFields64
        {
            ...
            private ulong stackReserveSize;

            private ulong stackCommitSize;

            private ulong heapReserveSize;

            private ulong heapCommitSize;
            ...
            /// <summary>
            /// Creates a new <see cref="NTFields64"/>
            ...
            /// targets.</param>
            public NTFields64(
                ulong imageBase, uint sectionAlignment, uint fileAlignment, DWordVersion osVersion,
                ...
                PEImageDllCharacteristics dllCharacteristics, ulong stackReserveSize, ulong stackCommitSize,
                ulong heapReserveSize, ulong heapCommitSize, uint dataDirectoryCount = DefaultDataDirectoryCount)
            {
            ...
            /// <see cref="PEImage"/>.
            /// </summary>
            public ulong ImageBase { get { return this.imageBase; } }
            ...
            public ulong StackReserveSize { get { return this.stackReserveSize; } }
            public ulong StackCommitSize { get { return this.stackCommitSize; } }
            public ulong HeapReserveSize { get { return this.heapReserveSize; } }
            public ulong HeapCommitSize { get { return this.heapCommitSize; } }
