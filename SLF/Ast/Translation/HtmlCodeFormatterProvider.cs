...
{
    internal class HtmlCodeFormatterProvider :
        IIntermediateCodeTranslatorFormatterProvider
    {
        ...
        <style>
            ...
            private void DefineDeclaration(IIntermediateMember declaration)
            {
                ...
                {
                    this.EndSpan();
                    this.HandleWriteInternal(string.Format("<a class=\"def\" name=\"{0}\">", declaration.Visit(this.translator.NameProvider, IntermediateNameRequestDetails.ReferenceName)));
                }
            }
            ...
            private void ReferenceDeclaration(IIntermediateType declaration)
            {
                ...
                {
                    EndSpan();
                    string name = declaration.Visit(this.translator.NameProvider, IntermediateNameRequestDetails.TargetFileName);
            ...
            public bool TryGetAssemblyFileName(out string fileName)
            {
                ...
                {
                    fileName = ((IIntermediateAssembly)first).Visit(this.translator.NameProvider, IntermediateNameRequestDetails.TargetFileName);
