...
namespace AllenCopeland.Abstraction.Slf.Languages.CSharp
{
    public static partial class CSharpCompilerMessages
    {
                ...
                IMember
        {
            ...
            return new CompilerSourceModelWarning<TMemberType, TBaseMemberType>(CS0108, member, original, member.Location, start, end, member.UniqueIdentifier.ToString(), original.UniqueIdentifier.ToString());
        }
                ...
                ISourceElement
        {
            var start = member.Start ?? LineColumnPair.Zero;
            var end = member.End ?? LineColumnPair.Zero;
            return new CompilerSourceModelWarning<TMember>(CS0109, member, member.Location, start, end, member.UniqueIdentifier.ToString());
        }
                ...
                IMember
        {
            var start = member.Start ?? LineColumnPair.Zero;
            var end = member.End ?? LineColumnPair.Zero;
            return new CompilerSourceModelWarning<TMemberType, TBaseMemberType>(CS0114, member, original, member.Location, start, end, member.UniqueIdentifier.ToString(), original.UniqueIdentifier.ToString());
        }
        ...
        public static ICompilerSourceModelWarning<IExpression> WarningCS0162(IExpression unreachableExpression)
        {
            ...
            return new CompilerSourceModelWarning<IExpression>(CS0162, unreachableExpression, unreachableExpression.Location, start, end, unreachableExpression.ToString());
        }
        ...
        public static ICompilerSourceModelWarning<ICSharpRelationalExpression> WarningCS0183(ICSharpRelationalExpression relationalConstant)
        {
            ...
            return new CompilerSourceModelWarning<ICSharpRelationalExpression>(CS0183, relationalConstant, relationalConstant.Location, start, end, relationalConstant.ToString());
        }
        ...
        public static ICompilerSourceModelWarning<IIndexerReferenceExpression> WarningCS0251(IIndexerReferenceExpression indexingExpression)
        {
            ...
            return new CompilerSourceModelWarning<IIndexerReferenceExpression>(CS0251, indexingExpression, indexingExpression.Location, start, end, indexingExpression.ToString());
        }
        ...
        public static ICompilerSourceModelWarning<IIndexerReferenceExpression<IClassIndexerMember, IClassType>> WarningCS0251(IIndexerReferenceExpression<IClassIndexerMember, IClassType> indexingExpression)
        {
            var start = indexingExpression.Start ?? LineColumnPair.Zero;
            var end = indexingExpression.End ?? LineColumnPair.Zero;
            return new CompilerSourceModelWarning<IIndexerReferenceExpression<IClassIndexerMember, IClassType>>(CS0251, indexingExpression, indexingExpression.Location, start, end, indexingExpression.ToString());
        }
        ...
        public static ICompilerSourceModelWarning<IIndexerReferenceExpression<IStructIndexerMember, IStructType>> WarningCS0251(IIndexerReferenceExpression<IStructIndexerMember, IStructType> indexingExpression)
        {
            var start = indexingExpression.Start ?? LineColumnPair.Zero;
            var end = indexingExpression.End ?? LineColumnPair.Zero;
            return new CompilerSourceModelWarning<IIndexerReferenceExpression<IStructIndexerMember, IStructType>>(CS0251, indexingExpression, indexingExpression.Location, start, end, indexingExpression.ToString());
        }
        ...
        public static ICompilerSourceModelWarning<IIndexerSignatureReferenceExpression<IInterfaceIndexerMember, IInterfaceType>> WarningCS0251(IIndexerSignatureReferenceExpression<IInterfaceIndexerMember, IInterfaceType> indexingExpression)
        {
            var start = indexingExpression.Start ?? LineColumnPair.Zero;
            var end = indexingExpression.End ?? LineColumnPair.Zero;
            return new CompilerSourceModelWarning<IIndexerSignatureReferenceExpression<IInterfaceIndexerMember, IInterfaceType>>(CS0251, indexingExpression, indexingExpression.Location, start, end, indexingExpression.ToString());
        }
        ...
        public static ICompilerSourceModelWarning<ICSharpInequalityExpression> WarningCS0252(ICSharpInequalityExpression inequalityExpression)
        {
            ...
            return new CompilerSourceModelWarning<ICSharpInequalityExpression>(CS0252, inequalityExpression, inequalityExpression.Location, start, end, inequalityExpression.ToString());
        }
        ...
        public static ICompilerSourceModelWarning<IExpression, IType, IMethodSignatureMember, IMethodSignatureMember> WarningCS0278(IExpression offendingExpression, IType offendingType, string patternName, IMethodSignatureMember patternMethod1, IMethodSignatureMember patternMethod2)
        {
            ...
            return new CompilerSourceModelWarning<IExpression, IType, IMethodSignatureMember, IMethodSignatureMember>(CS0278, offendingExpression, offendingType, patternMethod1, patternMethod2, offendingExpression.Location, start, end, offendingType.UniqueIdentifier.ToString(), patternName, patternMethod1.UniqueIdentifier.ToString(), patternMethod2.UniqueIdentifier.ToString());
        }
        ...
        public static ICompilerSourceModelWarning<IExpression, IType, string, IMethodSignatureMember> WarningCS0279(IExpression offendingExpression, IType offendingType, string patternName, IMethodSignatureMember offendingMethod)
        {
            var start = offendingExpression.Start ?? LineColumnPair.Zero;
            var end = offendingExpression.End ?? LineColumnPair.Zero;
            return new CompilerSourceModelWarning<IExpression, IType, string, IMethodSignatureMember>(CS0279, offendingExpression, offendingType, patternName, offendingMethod, offendingExpression.Location, start, end, offendingType.UniqueIdentifier.ToString(), patternName, offendingMethod.UniqueIdentifier.ToString());
        }
        /// <summary><para>Creates a C&#9839; compiler warning, relative to the 
