...
namespace AllenCopeland.Abstraction.Slf.Abstract
{
    ...
    public interface IPropertyParentType<TProperty, TPropertyParent> :
    ...
    {
        /// <summary>
        /// Returns the <see cref="IPropertyMemberDictionary{TProperty, TPropertyParent}"/> contained on the current <see cref="IPropertyParentType{TProperty, TPropertyParent}"/>
        /// </summary>
    ...
    /// of a series of properties.
    /// </summary>
    public interface IPropertyParentType :
        IMemberParent,
        IType
    {
        /// <summary>
        /// Returns the <see cref="IPropertyMemberDictionary"/> contained on the current <see cref="IPropertyParentType"/>
        /// </summary>
