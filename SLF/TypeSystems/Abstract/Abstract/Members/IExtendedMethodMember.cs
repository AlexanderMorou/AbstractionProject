...
namespace AllenCopeland.Abstraction.Slf.Abstract.Members
{
        ...
        IMethodMember
    {
        ...
        /// <summary>
        /// Returns the <see cref="ExtendedMethodAttributes"/> that determine how the
        /// <see cref="IExtendedMethodMember"/> is shown in its scope and inherited scopes.
        /// </summary>
        new ExtendedMethodAttributes Attributes { get; }

        /// <summary>
        /// Returns the <see cref="IEnumerable{T}"/> of <see cref="IInterfaceType"/>
        /// elements which the current <see cref="IExtendedMethodMember"/>
        /// implements.
        /// </summary>
        new IEnumerable<IInterfaceType> Implementations { get; }
    }
}
