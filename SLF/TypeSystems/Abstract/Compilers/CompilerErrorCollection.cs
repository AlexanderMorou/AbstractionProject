...
namespace AllenCopeland.Abstraction.Slf.Compilers
{
        ...
        ICompilerErrorCollection
    {
        ...
        public ICompilerSourceModelError<T1> SourceModelError<T1>(ICompilerReferenceError message, LineColumnPair start, LineColumnPair end, Uri source, T1 item1, params string[] replacements)
        {
            var error = new CompilerSourceModelError<T1>(message, item1, source, start, end, replacements);
            base.AddImpl(error);
            return error;
        }
        ...
        public ICompilerSourceModelError<T1, T2> SourceModelError<T1, T2>(ICompilerReferenceError message, LineColumnPair start, LineColumnPair end, Uri source, T1 item1, T2 item2, params string[] replacements)
        {
            var error = new CompilerSourceModelError<T1, T2>(message, item1, item2, source, start, end, replacements);
            base.AddImpl(error);
            return error;
        }
        ...
        public ICompilerSourceModelError<T1, T2, T3, T4> SourceModelError<T1, T2, T3, T4>(ICompilerReferenceError message, LineColumnPair start, LineColumnPair end, Uri source, T1 item1, T2 item2, T3 item3, T4 item4, params string[] replacements)
        {
            var error = new CompilerSourceModelError<T1, T2, T3, T4>(message, item1, item2, item3, item4, source, start, end, replacements);
            base.AddImpl(error);
            return error;
        }
        ...
        public ICompilerSourceModelWarning<T1> SourceModelWarning<T1>(ICompilerReferenceWarning message, LineColumnPair start, LineColumnPair end, Uri source, T1 item1, params string[] replacements)
        {
            var warning = new CompilerSourceModelWarning<T1>(message, item1, source, start, end, replacements);
            base.AddImpl(warning);
            return warning;
        }
        ...
        public ICompilerSourceModelWarning<T1, T2> SourceModelWarning<T1, T2>(ICompilerReferenceWarning message, LineColumnPair start, LineColumnPair end, Uri source, T1 item1, T2 item2, params string[] replacements)
        {
            var warning = new CompilerSourceModelWarning<T1, T2>(message, item1, item2, source, start, end, replacements);
            base.AddImpl(warning);
            return warning;
        }
        ...
        /// which represents the warning.</returns>
        public ICompilerSourceModelWarning<T1, T2, T3> SourceModelWarning<T1, T2, T3>(ICompilerReferenceWarning message, LineColumnPair start, LineColumnPair end, Uri source, T1 item1, T2 item2, T3 item3, params string[] replacements)
        {
            var warning = new CompilerSourceModelWarning<T1, T2, T3>(message, item1, item2, item3, source, start, end, replacements);
            base.AddImpl(warning);
            return warning;
        }
