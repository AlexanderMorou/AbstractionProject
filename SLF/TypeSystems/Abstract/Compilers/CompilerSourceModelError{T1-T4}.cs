...
namespace AllenCopeland.Abstraction.Slf.Compilers
{
        ...
        ICompilerSourceModelError<T1, T2>
    {
        ...
        /// which denotes the replacements within <paramref name="message"/> to build a unique
        /// message relative to the current error.</param>
        public CompilerSourceModelError(ICompilerReferenceError message, T1 item1, T2 item2, Uri source, LineColumnPair start, LineColumnPair end, params string[] replacements)
            : base(message, source, start, end, replacements)
        {
            this.Item1 = item1;
            this.Item2 = item2;
        ...
        ICompilerSourceModelError<T1, T2, T3>
    {
        ...
        /// which denotes the replacements within <paramref name="message"/> to build a unique
        /// message relative to the current error.</param>
        public CompilerSourceModelError(ICompilerReferenceError message, T1 item1, T2 item2, T3 item3, Uri source, LineColumnPair start, LineColumnPair end, params string[] replacements)
            : base(message, source, start, end, replacements)
        {
            this.Item1 = item1;
            this.Item2 = item2;
        ...
        ICompilerSourceModelError<T1, T2, T3, T4>
    {
        ...
        /// which denotes the replacements within <paramref name="message"/> to build a unique
        /// message relative to the current error.</param>
        public CompilerSourceModelError(ICompilerReferenceError message, T1 item1, T2 item2, T3 item3, T4 item4, Uri source, LineColumnPair start, LineColumnPair end, params string[] replacements)
            : base(message, source, start, end, replacements)
        {
            this.Item1 = item1;
            this.Item2 = item2;
