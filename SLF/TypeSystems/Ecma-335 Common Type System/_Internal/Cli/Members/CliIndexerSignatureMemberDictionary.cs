...
{
    internal class CliIndexerSignatureMemberDictionary<TIndexer, TIndexerParent> :
            ...
            IIndexerSignatureParent<TIndexer, TIndexerParent>
    {
        ...
        public CliIndexerSignatureMemberDictionary(TIndexerParent parent, CliFullMemberDictionary fullMembers)
            : base()
        {
            this.parent = parent;
