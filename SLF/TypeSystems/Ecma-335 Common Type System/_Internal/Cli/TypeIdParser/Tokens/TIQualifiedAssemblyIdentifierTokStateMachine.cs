...
{
    // Module: RootModule
    internal class TIQualifiedAssemblyIdentifierTokStateMachine :
        CharStream
    {
        #region TIQualifiedAssemblyIdentifierTokStateMachine data members
        /// <summary>
        ...
        #endregion // TIQualifiedAssemblyIdentifierTokStateMachine data members
        #region TIQualifiedAssemblyIdentifierTokStateMachine properties
        ...
        #endregion // TIQualifiedAssemblyIdentifierTokStateMachine properties
        #region TIQualifiedAssemblyIdentifierTokStateMachine methods
        public bool Next(char @char)
        {
            switch (this.state)
            {
                case 0:
                    if (((((('\0' <= @char) && (@char <= '!')) || (('#' <= @char) && (@char <= '+'))) || (('-' <= @char) && (@char <= '<'))) || (('>' <= @char) && (@char <= '['))) || ((']' <= @char) && (@char <= '\uffff')))
                        goto MOVETOSTATE1;
                    if ('\\' == @char)
                        goto MOVETOSTATE2;
                    break;
        ...
        public void Inject(TypeIdParserScanData data)
        {
            if (this.IsValidEndState)
                data.AddCapture(this.GetCapture(), TypeIdParserTokens.QualifiedAssemblyIdentifier);
        }
        #endregion // TIQualifiedAssemblyIdentifierTokStateMachine methods
    }
}
 /* ----------------------------------------------------\
 |  This file took 00:00:00.0004862 to generate.        |
