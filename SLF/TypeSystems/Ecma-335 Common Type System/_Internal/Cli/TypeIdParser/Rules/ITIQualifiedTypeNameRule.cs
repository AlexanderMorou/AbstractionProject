...
namespace AllenCopeland.Abstraction.Slf._Internal.Cli.TypeIdParser.Rules
{
    ...
    // Module: RootModule
    internal interface ITIQualifiedTypeNameRule
    {
        ITITypeIdentityRule TypeIdentifier { get; }
        ITIAssemblyIdentityRule AssemblyIdentifier { get; }
    }
}
 /* ----------------------------------------------\
 |  This file took 00:00:00.0001120 to generate.  |
