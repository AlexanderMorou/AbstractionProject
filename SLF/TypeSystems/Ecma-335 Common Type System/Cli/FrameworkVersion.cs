...
namespace AllenCopeland.Abstraction.Slf.Cli
{
    ...
    public enum CliFrameworkVersion
    {
        ...
        v2_0_50727     = 1 << 0xA,
        /// <summary>
        /// Version 3.0 of the Common Language Infrastructure where
        /// extension methods were introduced to the flagship compilers
        /// of the framework.
        /// </summary>
        v3_0           = 1 << 0xB,
        /// <summary>
        /// Version 3.5 of the Common Language Infrastructure
        /// where language integrated query was introduced as
        /// a sugar coating over the extension methods from version
        /// <see cref="v3_0"/>.
        /// </summary>
        v3_5           = 1 << 0xC,
        /// <summary>
        /// Version 4.0 (4.0.30319) of the Common Language
        /// Infrastructure where dynamic interop was introduced
        ...
        /// </summary>
        /// <remarks><see cref="ClientProfile"/> is not valid
        /// for version 4.5 of the framework.</remarks>
        v4_5           = 1 << 0xE,
        /// <summary>
