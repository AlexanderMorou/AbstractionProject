...
namespace AllenCopeland.Abstraction.Slf._Internal.Cli.Members
{
    internal abstract class EventSignatureMemberBase<TEvent, TEventParameter, TEventParent> :
        SignatureMemberBase<IGeneralSignatureMemberUniqueIdentifier, TEvent, TEventParameter, TEventParent>,
            ...
            IEventSignatureParent<TEvent, TEventParameter, TEventParent>
    {
        ...
        /// translation language.</para><para>The primary reason for this
        /// is: Vissual Basic can auto-generate the associated type, where
        /// as C&#9839; requires the signature to be a type already defined.  
        /// C&#9839; will emit an auto-generated type upon translation if
        /// <see cref="SignatureSource"/> is 
        /// <see cref="EventSignatureSource.Declared"/> and Visual Basic will
        /// not.</para></remarks>
