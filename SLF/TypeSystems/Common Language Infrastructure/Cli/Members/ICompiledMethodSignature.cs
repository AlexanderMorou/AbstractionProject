...
{
    /// <summary>
    /// Defines properties and methods for working with a compiled method signature member.
    /// </summary>
    public interface ICompiledMethodSignatureMember :
        IMethodSignatureMember,
        ICompiledMember
    {
        /// <summary>
        /// Returns the <see cref="MethodInfo"/> associated to the <see cref="ICompiledMethodSignatureMember"/>.
        /// </summary>
        new MethodInfo MemberInfo { get; }
        /// <summary>
        /// Invokes the <see cref="MemberInfo"/> associated to the <see cref="ICompiledMethodSignatureMember"/>
