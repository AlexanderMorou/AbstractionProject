...
{
    public struct StatementKind
    {
        
        /// <summary>
        /// Provides a series of values relative to the innately
        /// supported kinds of statements which contain statement
        /// blocks which declare new scopes.
        /// </summary>
        public enum BlockedStatementSector :
            short
        {
            /// <summary>
            ...
            /// action with the ability to catc errors based upon
            ...
            short
        {
            ...
            /// field, or local.
            /// </summary>
            AssignmentStatement                 = 0x0000000000000001,
            /// <summary>
            /// The statement breaks out of the flow from a breakable
            /// block statement.
            /// </summary>
            BreakStatement                      = 0x0000000000000002,
            /// <summary>
            /// The statement invokes a method.
            /// </summary>
            CallStatement                       = 0x0000000000000004,
            CallFusionStatement                 = 0x0000000000000008,
            /// <summary>
            /// The statement invokes a method in a series
            /// of calls under the same name but with different
            /// parameters.
            /// </summary>
            CallSetSeriesStatement              = 0x0000000000000008,
            /// <summary>
            ...
            /// </remarks>
            ReturnStatement                     = 0x0000000000000800,
            /// <summary>
            /// The statement represents a means to throw an 
            /// exception.
            /// </summary>
            ThrowStatement                      = 0x0000000000001000,
        }
    }
}
