...
namespace AllenCopeland.Abstraction.Slf.Compilers
{
    ...
    {
        public CompilerSourceModelWarning(ICompilerReferenceWarning message, T1 item1, string fileName, int line, int column, params string[] replacements)
    ...
    {
        public CompilerSourceModelWarning(ICompilerReferenceWarning message, T1 item1, T2 item2, string fileName, int line, int column, params string[] replacements)
    ...
    {
        public CompilerSourceModelWarning(ICompilerReferenceWarning message, T1 item1, T2 item2, T3 item3, string fileName, int line, int column, params string[] replacements)
    ...
    {
        public CompilerSourceModelWarning(ICompilerReferenceWarning message, T1 item1, T2 item2, T3 item3, T4 item4, string fileName, int line, int column, params string[] replacements)
