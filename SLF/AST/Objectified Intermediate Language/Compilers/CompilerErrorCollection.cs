...
namespace AllenCopeland.Abstraction.Slf.Compilers
{
        ...
        ICompilerErrorCollection
    {
        ...
        public ICompilerSourceWarning SourceWarning(ICompilerReferenceWarning message, int line, int column, string fileName, params string[] replacements)
        {
        ...
        public ICompilerSourceError SourceError(ICompilerReferenceError message, int line, int column, string fileName, params string[] replacements)
        {
            CompilerSourceError error = new CompilerSourceError(message, fileName, line, column, replacements);
            base.AddImpl(error);
            return error;
        }
