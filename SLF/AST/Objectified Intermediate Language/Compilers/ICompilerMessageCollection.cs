...
namespace AllenCopeland.Abstraction.Slf.Compilers
{
        ...
        IControlledStateCollection<ICompilerMessage>
    {
        ...
        ICompilerWarning Warning(ICompilerReferenceWarning message, int column, int line, string fileName, params string[] replacements);
        /// <summary>
        ...
        ICompilerError Error(ICompilerReferenceError message, int column, int line, string fileName, params string[] replacements);
