...
{
    public interface ICliMetadataMutableRoot :
        ICliMetadataRoot
    {
        /// <summary>
        ...
        /// </summary>
        new ICliMetadataMutableUserStringsHeaderAndHeap UserStringsHeap { get; }
        ...
        /// </summary>
        new ICliMetadataMutableGuidHeaderAndHeap GuidHeap { get; }
        ...
        /// </summary>
        new ICliMetadataMutableBlobHeaderAndHeap BlobHeap { get; }
        ...
        /// </summary>
        new ICliMetadataMutableTableStreamAndHeader TableStream { get; }
