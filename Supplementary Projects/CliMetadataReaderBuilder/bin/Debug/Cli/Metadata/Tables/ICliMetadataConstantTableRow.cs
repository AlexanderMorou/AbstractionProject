...
namespace AllenCopeland.Abstraction.Slf.Cli.Metadata.Tables
{
    ...
    /// about the constants within the image.
    /// </summary>
    public interface ICliMetadataConstantTableRow :
        ICliMetadataTableRow
    {
        /// <summary>
        /// Returns the root of the metadata from which the current <see cref="ICliMetadataConstantTableRow"/>
        /// was derived.
        /// </summary>
        ICliMetadataRoot MetadataRoot { get; }
        CliMetadataNativeTypes Type { get; }
        ICliMetadataHasConstantRow Parent { get; }
        /// <summary>
        ...
        /// </list>
        /// </remarks>
        CliMetadataHasConstantTag ParentSource { get; }
        byte[] Value { get; }
        /// <summary>
