...
{
    /// <summary>
    /// Defines the umbrella interface for reference indexes encoded with <see cref="CliMetadataImplementationTag"/>.
    /// </summary>
    public interface ICliMetadataImplementationRow
    {
        /// <summary>
        /// Returns the <see cref="AllenCopeland.Abstraction.Slf.Cli.Metadata.ICliMetadataRoot"/>
        /// metadataRoot associated to the row encoded with <see cref="AllenCopeland.Abstraction.Slf.Cli.Metadata.CliMetadataImplementationTag"/>.
        /// </summary>
        ICliMetadataRoot MetadataRoot { get; }
        /// <summary>
        /// Returns the <see cref="System.String"/> name associated to the row encoded with <see cref="AllenCopeland.Abstraction.Slf.Cli.Metadata.CliMetadataImplementationTag"/>.
        /// </summary>
        string Name { get; }
        /// <summary>
        ...
        /// associated to the row encoded with <see cref="AllenCopeland.Abstraction.Slf.Cli.Metadata.CliMetadataImplementationTag"/>.
        /// </summary>
        IControlledCollection<ICliMetadataCustomAttributeTableRow> CustomAttributes { get; }
        /// <summary>
        /// Returns the source table from which the current <see cref="ICliMetadataImplementationRow"/>
        /// is derived.
        /// </summary>
        CliMetadataImplementationTag ImplementationEncoding { get; }
    };
};
