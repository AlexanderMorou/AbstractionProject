...
{
    /// <summary>
    /// Defines properties and methods for a locked row in a table which defines the property
    /// mapping of a type defined within the module.
    /// </summary>
    public interface ICliMetadataPropertyMapTableRow :
        ICliMetadataTableRow, 
        ICliMetadataIndexedRow
    {
        /// <summary>
        /// Returns the root of the metadata from which the current <see cref="ICliMetadataPropertyMapTableRow"/>
        /// was derived.
        /// </summary>
