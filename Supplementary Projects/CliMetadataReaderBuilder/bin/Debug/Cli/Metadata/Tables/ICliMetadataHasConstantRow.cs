...
{
    /// <summary>
    /// Defines the umbrella interface for reference indexes encoded with <see cref="CliMetadataHasConstantTag"/>.
    /// </summary>
    public interface ICliMetadataHasConstantRow
    {
        /// <summary>
        /// Returns the <see cref="AllenCopeland.Abstraction.Slf.Cli.Metadata.ICliMetadataRoot"/>
        /// metadataRoot associated to the row encoded with <see cref="AllenCopeland.Abstraction.Slf.Cli.Metadata.CliMetadataHasConstantTag"/>.
        /// </summary>
        ICliMetadataRoot MetadataRoot { get; }
        /// <summary>
        /// Returns the <see cref="System.String"/> name associated to the row encoded with <see cref="AllenCopeland.Abstraction.Slf.Cli.Metadata.CliMetadataHasConstantTag"/>.
        /// </summary>
        string Name { get; }
        /// <summary>
        ...
        /// associated to the row encoded with <see cref="AllenCopeland.Abstraction.Slf.Cli.Metadata.CliMetadataHasConstantTag"/>.
        /// </summary>
        IControlledCollection<ICliMetadataCustomAttributeTableRow> CustomAttributes { get; }
        /// <summary>
        /// Returns the source table from which the current <see cref="ICliMetadataHasConstantRow"/>
        /// is derived.
        /// </summary>
        CliMetadataHasConstantTag HasConstantEncoding { get; }
    };
};
