...
{
    /// <summary>
    /// Provides a table which defines the external files associated to the assembly.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    internal class CliMetadataFileTableReader :
        CliMetadataLazyTable<ICliMetadataFileTableRow>, 
        ICliMetadataTable, 
        ICliMetadataFileTable
    {
        ...
        /// <summary>
        /// Size constant used when the total size of the <see cref="CliMetadataFileLockedTableRow"/>
        /// is 8 bytes long.
        /// </summary>
        internal const int __COR_FILE_CALC_SIZE_1__ = 8;
        /// <summary>
        /// Size constant used when the total size of the <see cref="CliMetadataFileLockedTableRow"/>
        /// is 10 bytes long.
        /// </summary>
        internal const int __COR_FILE_CALC_SIZE_2__ = 10;
        /// <summary>
        /// Size constant used when the total size of the <see cref="CliMetadataFileLockedTableRow"/>
        /// is 12 bytes long.
        /// </summary>
        internal const int __COR_FILE_CALC_SIZE_3__ = 12;
        private int __size;
        private byte state;
        /// <summary>
        /// Data member which denotes where in the original stream the <see cref="CliMetadataFileTableReader"/>
        /// is.
        /// </summary>
        ...
        public override CliMetadataTableKinds Kind
        {
            get
            {
                return CliMetadataTableKinds.File;
            }
        }
        public long Length
        {
        ...
        /// <summary>
        /// Initializes the <see cref="CliMetadataFileTableReader"/> with the <paramref name="streamOffset"/>,<paramref name="blobHeapSize"/>,
        ...
        /// the <see cref="CliMetadataFileTableReader"/> is.
        /// </param>
        ...
        internal void Initialize(long streamOffset, CliMetadataReferenceIndexSize blobHeapSize, CliMetadataReferenceIndexSize stringsHeapSize)
        {
            ...
            if (blobHeapSize == CliMetadataReferenceIndexSize.DWord)
                ...
                {
                    this.state = 3;
                    this.__size = CliMetadataFileTableReader.__COR_FILE_CALC_SIZE_3__;
                }
                else
                {
                    this.state = 1;
                    this.__size = CliMetadataFileTableReader.__COR_FILE_CALC_SIZE_2__;
                }
            ...
            {
                this.state = 0;
                this.__size = CliMetadataFileTableReader.__COR_FILE_CALC_SIZE_1__;
            }
            this.length = this.__size * this.rowCount;
        }
        protected override ICliMetadataFileTableRow ReadElementAt(uint index)
        {
            bool gotLock = false;
            ...
            return new CliMetadataFileLockedTableRow(index, this.state, this.metadataRoot, flags, nameIndex, hashValueIndex);
        }
        public override void Read()
        {
            ...
            for (uint index = 1; index <= this.Count; index++)
            {
                ...
                if (!base.ItemLoaded(index))
                {
                    ...
                    base.InjectLoadedItem(new CliMetadataFileLockedTableRow(index, this.state, this.metadataRoot, flags, nameIndex, hashValueIndex), index);
                }
                if (gotLock)
                    System.Threading.Monitor.Exit(this.syncObject);
            }
        ...
        public CliMetadataFileTableReader(ICliMetadataRoot metadataRoot, Tuple<object, FileStream, EndianAwareBinaryReader> readerInfo, uint rowCount)
