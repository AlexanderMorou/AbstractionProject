...
{
    /// <summary>
    /// Provides a table which defines the event mapping of a type defined within the module.
    /// </summary>
    internal class CliMetadataEventMapTableReader :
        CliMetadataLazyTable<ICliMetadataEventMapTableRow>, 
        ICliMetadataTable, 
        ICliMetadataEventMapTable
    {
        ...
        /// <summary>
        /// Size constant used when the total size of the <see cref="CliMetadataEventMapLockedTableRow"/>
        /// is 4 bytes long.
        /// </summary>
        internal const int __COR_EVENTMAP_CALC_SIZE_1__ = 4;
        /// <summary>
        /// Size constant used when the total size of the <see cref="CliMetadataEventMapLockedTableRow"/>
        /// is 6 bytes long.
        /// </summary>
        internal const int __COR_EVENTMAP_CALC_SIZE_2__ = 6;
        /// <summary>
        /// Size constant used when the total size of the <see cref="CliMetadataEventMapLockedTableRow"/>
        /// is 8 bytes long.
        /// </summary>
        internal const int __COR_EVENTMAP_CALC_SIZE_3__ = 8;
        private int __size;
        private byte state;
        /// <summary>
        /// Data member which denotes where in the original stream the <see cref="CliMetadataEventMapTableReader"/>
        /// is.
        /// </summary>
        ...
        public override CliMetadataTableKinds Kind
        {
            get
            {
                return CliMetadataTableKinds.EventMap;
            }
        }
        public long Length
        {
        ...
        protected override ICliMetadataEventMapTableRow ReadElementAt(uint index)
        {
            bool gotLock = false;
            ...
            {
                case 1: case 3:
                    eventListIndex = this.reader.ReadUInt32();
                    break;
                default:
                    eventListIndex = this.reader.ReadUInt16();
                    break;
            }
            if (gotLock)
                System.Threading.Monitor.Exit(this.syncObject);
            return new CliMetadataEventMapLockedTableRow(index, this.state, this.metadataRoot, parentIndex, eventListIndex);
        }
        public override void Read()
        {
            ...
            for (uint index = 1; index <= this.Count; index++)
            {
                ...
                if (!base.ItemLoaded(index))
                {
                    ...
                    base.InjectLoadedItem(new CliMetadataEventMapLockedTableRow(index, this.state, this.metadataRoot, parentIndex, eventListIndex), index);
                }
                if (gotLock)
                    System.Threading.Monitor.Exit(this.syncObject);
            }
        ...
        public CliMetadataEventMapTableReader(ICliMetadataRoot metadataRoot, Tuple<object, FileStream, EndianAwareBinaryReader> readerInfo, uint rowCount)
