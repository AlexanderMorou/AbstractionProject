...
{
    /// <summary>
    /// Provides a table which defines information about a field's relative virtual address.
    /// </summary>
    internal class CliMetadataFieldRVATableReader :
        CliMetadataLazyTable<ICliMetadataFieldRVATableRow>, 
        ICliMetadataTable, 
        ICliMetadataFieldRVATable
    {
        ...
        /// <summary>
        /// Size constant used when the total size of the <see cref="CliMetadataFieldRVALockedTableRow"/>
        /// is 6 bytes long.
        /// </summary>
        internal const int __COR_FIELDRVA_CALC_SIZE_1__ = 6;
        /// <summary>
        /// Size constant used when the total size of the <see cref="CliMetadataFieldRVALockedTableRow"/>
        /// is 8 bytes long.
        /// </summary>
        internal const int __COR_FIELDRVA_CALC_SIZE_2__ = 8;
        private int __size;
        private byte state;
        /// <summary>
        /// Data member which denotes where in the original stream the <see cref="CliMetadataFieldRVATableReader"/>
        /// is.
        /// </summary>
        ...
        public override CliMetadataTableKinds Kind
        {
            get
            {
                return CliMetadataTableKinds.FieldRelativeVirtualAddress;
            }
        }
        public long Length
        {
        ...
        protected override ICliMetadataFieldRVATableRow ReadElementAt(uint index)
        {
            bool gotLock = false;
            ...
            return new CliMetadataFieldRVALockedTableRow(this.state, this.metadataRoot, rva, fieldIndex);
        }
        public override void Read()
        {
            ...
            for (uint index = 1; index <= this.Count; index++)
            {
                ...
                if (!base.ItemLoaded(index))
                {
                    ...
                    base.InjectLoadedItem(new CliMetadataFieldRVALockedTableRow(this.state, this.metadataRoot, rva, fieldIndex), index);
                }
                if (gotLock)
                    System.Threading.Monitor.Exit(this.syncObject);
            }
        ...
        public CliMetadataFieldRVATableReader(ICliMetadataRoot metadataRoot, Tuple<object, FileStream, EndianAwareBinaryReader> readerInfo, uint rowCount)
