...
{
    /// <summary>
    /// Provides a table which defines information about the image's fields.
    /// </summary>
    internal class CliMetadataFieldTableReader :
        CliMetadataLazyTable<ICliMetadataFieldTableRow>, 
        ICliMetadataTable, 
        ICliMetadataFieldTable
    {
        ...
        /// <summary>
        /// Size constant used when the total size of the <see cref="CliMetadataFieldLockedTableRow"/>
        /// is 6 bytes long.
        /// </summary>
        internal const int __COR_FIELD_CALC_SIZE_1__ = 6;
        /// <summary>
        /// Size constant used when the total size of the <see cref="CliMetadataFieldLockedTableRow"/>
        /// is 8 bytes long.
        /// </summary>
        internal const int __COR_FIELD_CALC_SIZE_2__ = 8;
        /// <summary>
        /// Size constant used when the total size of the <see cref="CliMetadataFieldLockedTableRow"/>
        /// is 10 bytes long.
        /// </summary>
        internal const int __COR_FIELD_CALC_SIZE_3__ = 10;
        private int __size;
        private byte state;
        /// <summary>
        /// Data member which denotes where in the original stream the <see cref="CliMetadataFieldTableReader"/>
        /// is.
        /// </summary>
        ...
        public override CliMetadataTableKinds Kind
        {
            get
            {
                return CliMetadataTableKinds.Field;
            }
        }
        public long Length
        {
        ...
        /// <summary>
        /// Initializes the <see cref="CliMetadataFieldTableReader"/> with the <paramref name="streamOffset"/>,<paramref name="blobHeapSize"/>,
        ...
        /// the <see cref="CliMetadataFieldTableReader"/> is.
        /// </param>
        ...
        internal void Initialize(long streamOffset, CliMetadataReferenceIndexSize blobHeapSize, CliMetadataReferenceIndexSize stringsHeapSize)
        {
            ...
            if (blobHeapSize == CliMetadataReferenceIndexSize.DWord)
                ...
                {
                    this.state = 3;
                    this.__size = CliMetadataFieldTableReader.__COR_FIELD_CALC_SIZE_3__;
                }
                else
                {
                    this.state = 1;
                    this.__size = CliMetadataFieldTableReader.__COR_FIELD_CALC_SIZE_2__;
                }
            ...
            {
                this.state = 0;
                this.__size = CliMetadataFieldTableReader.__COR_FIELD_CALC_SIZE_1__;
            }
            this.length = this.__size * this.rowCount;
        }
        protected override ICliMetadataFieldTableRow ReadElementAt(uint index)
        {
            bool gotLock = false;
            ...
            FieldAttributes fieldAttributes = ((FieldAttributes)(this.reader.ReadUInt16()));
            uint nameIndex;
            switch (this.state)
            {
                case 2: case 3:
            ...
            {
                case 1: case 3:
                    fieldTypeIndex = this.reader.ReadUInt32();
                    break;
                default:
                    fieldTypeIndex = this.reader.ReadUInt16();
                    break;
            }
            if (gotLock)
                System.Threading.Monitor.Exit(this.syncObject);
            return new CliMetadataFieldLockedTableRow(index, this.state, this.metadataRoot, fieldAttributes, nameIndex, fieldTypeIndex);
        }
        public override void Read()
        {
            ...
            for (uint index = 1; index <= this.Count; index++)
            {
                ...
                if (!base.ItemLoaded(index))
                {
                    ...
                    base.InjectLoadedItem(new CliMetadataFieldLockedTableRow(index, this.state, this.metadataRoot, fieldAttributes, nameIndex, fieldTypeIndex), index);
                }
                if (gotLock)
                    System.Threading.Monitor.Exit(this.syncObject);
            }
        ...
        public CliMetadataFieldTableReader(ICliMetadataRoot metadataRoot, Tuple<object, FileStream, EndianAwareBinaryReader> readerInfo, uint rowCount)
