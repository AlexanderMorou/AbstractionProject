...
namespace AllenCopeland.Abstraction.OldCodeGen.Translation
{
    public interface IIntermediateTranslator
    {
        ...
        /// <summary>
        /// Translates an expression used to instanciate the default value of a type.
        /// </summary>
        /// <param name="expression">The <see cref="IDefaultValueExpression"/> to translate.</param>
        void TranslateExpression(IDefaultValueExpression expression);
        ...
        /// </summary>
        /// <param name="throwStatement">The <see cref="IThrowStatement"/>
        /// which details the expression which raises an exception.</param>
        void TranslateStatement(IThrowStatement throwStatement);
        /// <summary>
        ...
        /// <summary>
        /// Translates a lock statement which coerces the access to the
        /// memory associated to the target expression.
        /// </summary>
        /// <param name="lockStatement">The <see cref="ILockStatement"/> to translate.</param>
        void TranslateStatement(ILockStatement lockStatement);
        /// <summary>
