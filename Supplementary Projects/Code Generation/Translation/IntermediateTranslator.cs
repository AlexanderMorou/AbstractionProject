...
namespace AllenCopeland.Abstraction.OldCodeGen.Translation
{
        ...
        IIntermediateTranslator
    {
        ...
        public virtual void TranslateStatement(IStatement statement)
        {
            if (statement is IAssignStatement)
            ...
            else if (statement is IThrowStatement)
                this.TranslateStatement((IThrowStatement)statement);
                ...
                this.TranslateStatement((ILockStatement)statement);
        ...
        public abstract void TranslateExpression(IShiftExpression expression);
        ...
        public virtual void TranslateExpression(IExpression expression)
        {
            ...
            else if (expression is IDefaultValueExpression)
                TranslateExpression((IDefaultValueExpression)expression);
            ...
            else if (expression is IShiftExpression)
                TranslateExpression((IShiftExpression)expression);
        ...
        public abstract void TranslateExpression(IDefaultValueExpression expression);
        ...
        public abstract void TranslateStatement(IThrowStatement throwStatement);
