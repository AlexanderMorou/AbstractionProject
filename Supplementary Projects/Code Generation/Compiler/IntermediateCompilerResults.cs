...
namespace AllenCopeland.Abstraction.OldCodeGen.Compiler
{
        ...
        IIntermediateCompilerResults
    {
        ...
        /// </summary>
        private IControlledStateCollection<IIntermediateCompilerError> errors;
        /// <summary>
        /// Data member for <see cref="Warnings"/>.
        /// </summary>
        private IControlledStateCollection<IIntermediateCompilerError> warnings;
        ...
        /// </summary>
        public IControlledStateCollection<IIntermediateCompilerError> Errors
        {
        ...
        /// </summary>
        public IControlledStateCollection<IIntermediateCompilerError> Warnings
        {
