...
namespace CliMetadataReader
{
    ...
    public class MetadataTableField
    {
        ...
        public IIntermediateClassFieldMember FieldReference { get; set; }

        public IIntermediateClassPropertyMember PropertyReference { get; set; }

        public string RemarksText { get; set; }

        public IIntermediatePropertyMember PropertyIndexReference { get; set; }
